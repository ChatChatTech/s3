...
```bash
docker build --build-arg SGL_BRANCH=v0.3.6 -t v0.3.6-rocm620 -f Dockerfile.rocm .
...
drun v0.3.6-rocm620 python3 -m sglang.bench_one_batch --batch-size 32 --input 1024 --output 128 --model amd/Meta-Llama-3.1-8B-Instruct-FP8-KV --tp 8 --quantization fp8
```
